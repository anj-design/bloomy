...
{
    class Program // okay before we start balak ko lng sabihin na ayaw ko na
    {
    ...
    class Progress
    {
        ...
        {
            Console.Clear();
            calendar.DrawCalendar(monthNames[currentMonth], monthData[currentMonth][0], monthData[currentMonth][1], currentMonth + 1);
